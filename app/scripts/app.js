...
.value('urlParams', {
  ...
  sendMeMail : '/teachers/sendEmailStudentListToTeacher',
  sendStudentMail : '/teachers/sendEmailStudentInfoToStudent', 
  ...
  addStudentCsv :'/teachers/addStudentCsv',
  sendMailToStudents : '/teachers/sendEmailOfScopeToStudent',
}).value('REGEX', {
